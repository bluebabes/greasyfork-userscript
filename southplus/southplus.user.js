...
// @version      0.0.9
// @author       bluebabes
// @namespace    bbs.imoutolove.me
// @include      https://www.south-plus.net/*
// @include      https://bbs.imoutolove.me/*
// @updateURL    https://raw.githubusercontent.com/bluebabes/greasyfork-userscript/main/southplus/southplus.user.js
// @downloadURL  https://raw.githubusercontent.com/bluebabes/greasyfork-userscript/main/southplus/southplus.user.js
...
$(document).ready(function () {
  ...
  if (isUrlList()) {
    ...
    var table = document.querySelector("#ajaxtable");
...
//        td.remove();
     // });
      ...
      ths.forEach((th) => {
        var as = th.querySelectorAll("h3 > a");
        for (let i = 0; i < as.length; i++) {
          ...
          if ( hrefth.indexOf("javascript") >= 0
          ) {
            continue;
          }
          ...
          getData(UrlComplate(hrefth))
            .then((data) => {
              ...
              // 图片
              var zooms = doc.querySelectorAll(".tpc_content img");
              var imgs = [];
              zooms.forEach((ele) => {

                 let src =ele.getAttribute("src");

                  if (src.indexOf("smallface")>0) {
